    ...
    <div className="bg-white rounded-[40px] shadow-2xl border border-slate-100 overflow-hidden">
      ...
      <form onSubmit={handleSubmit} className="p-7 space-y-7">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 bg-slate-50 p-5 rounded-[28px] border border-slate-100">
           ...
           <div className="space-y-1"><SupervisionScope department={form.don_vi_duoc_kiem_tra} onDepartmentChange={v => setField('don_vi_duoc_kiem_tra', v)} userDepartment={currentUser?.department} departments={deptList} idPrefix="cap-cuu" label="Khoa được giám sát" required containerClassName="space-y-1" labelClassName="text-[10px] font-black text-slate-400 uppercase tracking-widest pl-2" inputClassName="w-full p-2.5 rounded-xl border border-slate-200 text-sm font-bold outline-none focus:ring-2 focus:ring-green-200" /></div>
