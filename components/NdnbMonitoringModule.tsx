      ...
      <div className="p-4 md:p-6 max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          ...
          {(activeTab === 'OVERVIEW' || activeTab === 'REPORT') && viewMode === 'LIST' && (
            <button onClick={() => { setEditingItem(null); setActiveTab('CRITERIA'); setViewMode('FORM'); }} className="w-full lg:w-auto flex items-center justify-center gap-2 rounded-2xl bg-[#059669] px-6 py-3 text-xs font-black uppercase tracking-wider text-white shadow-xl shadow-green-200 transition-all hover:bg-[#0d6e39] active:scale-95">
