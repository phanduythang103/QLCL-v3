               ...
               <div className="flex flex-wrap gap-3">
                  {[
                    ...
                    <button
                      ...
                      className={`px-10 py-4 rounded-xl border transition-all text-xs font-black uppercase ${
                        formData.respondent === opt.value 
        ...
        <div className="bg-white p-8 md:p-10 rounded-[2rem] border border-slate-100 shadow-xl space-y-8">
          ...
          <div className="bg-emerald-50/50 p-6 rounded-2xl border border-emerald-100 flex items-start gap-4">
            ...
            <p className="italic text-emerald-800 text-sm font-medium leading-relaxed">
              Vui lòng chọn mức độ từ 1 đến 5 (1: Rất kém &rarr; 5: Rất tốt). Trường hợp không sử dụng dịch vụ hãy chọn số 0.
            </p>
          </div>
                        ...
                        {[1, 2, 3, 4, 5, 0].map(val => (
                          <div key={val} className="flex flex-col items-center gap-1 min-w-[50px]">
                            <button
                              ...
                              className={`w-11 h-11 rounded-full border-2 transition-all flex items-center justify-center text-sm font-black ${
                                (formData[`q${q.id}` as keyof InpatientSurveyResponse] as number) === val
                      ...
                      {[
                        ...
                        <button
                          ...
                          className={`p-5 rounded-2xl border text-left transition-all ${
                            formData.return_intent === opt.value
